<div class="container">
    <div class="row justify-content-center">
    	<div class="col-10">
          ...
          <hr>
          <div class="col-6">
            <button type="button" class="btn btn-outline-success" onclick="document.location.href='<?=base_url('Home/formInput')?>'">+ Data</button>
          </div>
                <div class="col-6">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a class="" href="<?= base_url('Home/formEdit/'). $row->nim?>">Edit</a></td>
